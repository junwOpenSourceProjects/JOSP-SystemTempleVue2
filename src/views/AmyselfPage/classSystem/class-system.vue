 ...
 * @LastEditTime: 2022-10-05 12:45:38
 * @LastEditors: junw 45444154+wo1261931780@users.noreply.github.com
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \vue-admin-self\src\views\AmyselfPage\classSystem\echart-test-page.vue
-->
<template>
  <div class="app-container">
      ...
      <el-main>
        ...
        <el-table border style="width: 100%" stripe :data="class_data">
          <el-table-column
            ...
            width="100%"
          />
          <el-table-column label="教室1" align="center" width="100%">
            <el-table-column
              label="学生"
              sortable
              fixed
          ...
          <el-table-column label="教室2" align="center" width="100%">
            <el-table-column
              label="学生"
              sortable
              fixed
          ...
          <el-table-column label="教室3" align="center" width="100%">
            <el-table-column
              label="学生"
              sortable
              fixed
    ...
    <el-dialog title="账单弹出框" :visible.sync="charge_info">
      <el-table :data="class_data" stripe style="width: 100%">
        <el-table-column
          label="学生"
          property="st_name"
